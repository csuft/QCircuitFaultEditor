...
//void XMLAttribute::SetAttribute( CString v )
////  By AS
//{
//	//char buf[5000];//char buf[BUF_SIZE];
//
//	wchar_t* p = v.GetBuffer();
//
...
//		p,     // wide character string to convert
...
//
//	char *buf = new char[nbytes + 100];//char buf[BUF_SIZE];
...
void XMLElement::SetText(char* inText )
{
	if ( FirstChild() && FirstChild()->ToText() )
...
//void XMLElement::SetText(CString inTextCString)
//{
//	wchar_t* p = inTextCString.GetBuffer();
//
//	int nlength=wcslen(p);
//	
//	//获取转换后的长度
...
//XMLError XMLDocument::LoadFileUsingCFile(CString filename)
//// AS
//// 2014_07_22
////
//{
...
//		{
//			MessageBox(NULL, L"没有文件!", L"LoadFileUsingCFile Error", 0);
...
//		_charBuffer = new char[size+1];
//		int byteRead = -1;
//		byteRead = file.Read(_charBuffer, sizeof(char) * size);//file.Read(_charBuffer, sizeof(_charBuffer));
//		file.Close();
//		
//    }
...
//		MessageBox(NULL, str, L"LoadFileUsingCFile Error", 0);
//		file.Abort();
//		e->Delete();
//
//		SetError(XML_ERROR_FILE_READ_ERROR, 0, 0);
...
//
//    ParseDeep( _charBuffer + (p-_charBuffer), 0 );
//    return _errorID;	// It seems to me that the Clear() function invoked at the beginning set the _errorID to an appropriate value.
//}
