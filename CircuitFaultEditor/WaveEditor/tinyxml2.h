...
public:
    ...
    */
	...
	/// Set the attribute to value. // By AS  // 2014_07_28
	//void SetAttribute( CString value );
...
public:
    ...
    */
	...
	///// By AS
	///// 2014_07_28
	//void SetAttribute( const char* name, CString value )		{
	//	XMLAttribute* a = FindOrCreateAttribute( name );
	//	a->SetAttribute( value );
	//}
    ...
    */
	...
	/// By AS
	/// 2014_07_23
	//void SetText(CString inTextCString);
...
public:
    ...
    */
	...
	/**
		AS 2014_07_22
	*/
	//XMLError LoadFileUsingCFile( CString filename ); 
